(() => {
    ...
    var $ = {};
    cr($, {
        createTailwindMerge: () => S,
        extendTailwindMerge: () => kr,
        fromTheme: () => d,
        getDefaultConfig: () => T,
        join: () => Jr,
        mergeConfigs: () => O,
    ...
    function E() {
        for (var r = 0, e, t, o = ""; r < arguments.length;)(e = arguments[r++]) && (t = ur(e)) && (o && (o += " "), o += t);
        return o
    }

    function ur(r) {
        if (typeof r == "string") return r;
        for (var e, t = "", o = 0; o < r.length; o++) r[o] && (e = ur(r[o])) && (t && (t += " "), t += e);
        return t
    }
    var H = "-";
    ...
    function br(r) {
        var e = Ir(r),
            ...
            o = r.conflictingClassGroupModifiers,
            a = o === void 0 ? {} : o;

        function s(i) {
            var c = i.split(H);
            return c[0] === "" && c.length !== 1 && c.shift(), gr(c, e) || Gr(i)
        }

        function n(i, c) {
            var u = t[i] || [];
            return c && a[i] ? [].concat(u, a[i]) : u
        }
        return {
            getClassGroupId: s,
    ...
    function gr(r, e) {
        ...
        var t = r[0],
            o = e.nextPart.get(t),
            a = o ? gr(r.slice(1), o) : void 0;
        if (a) return a;
        if (e.validators.length !== 0) {
            var s = r.join(H);
            return e.validators.find(function(n) {
                var i = n.validator;
                return i(s)
            }) ? .classGroupId
        }
    ...
    function Ir(r) {
        var e = r.theme,
            ...
            a = Tr(Object.entries(r.classGroups), t);
    ...
    function fr(r, e) {
        var t = r;
        return e.split(H).forEach(function(o) {
    ...
    function mr(r) {
        ...
        function a(s, n) {
            t.set(s, n), e++, e > r && (e = 0, o = t, t = new Map)
        }
        return {
            get: function(n) {
                var i = t.get(n);
    ...
    function vr(r) {
        var e = r.separator || ":",
            ...
            a = e.length;
        return function(n) {
            for (var i = [], c = 0, u = 0, b, f = 0; f < n.length; f++) {
                var g = n[f];
                if (c === 0) {
            ...
            var y = i.length === 0 ? n : n.substring(u),
                x = y.startsWith(Q),
                m = x ? y.substring(1) : y,
                w = b && b > u ? b - u : void 0;
            return {
    ...
    function xr(r, e) {
        ...
        return r.trim().split(Rr).map(function(n) {
            ...
            var i = n.modifierId,
                ...
                b = i + c;
            return s.has(b) ? !1 : (s.add(b), a(c, u).forEach(function(f) {
                return s.add(i + f)
            }), !0)
    ...
    function S() {
        ...
        function i(u) {
            var b = e[0],
                f = e.slice(1),
                g = f.reduce(function(y, x) {
                    return x(y)
                }, b());
            return o = yr(g), a = o.cache.get, s = o.cache.set, n = c, c(u)
        }
    ...
    var Cr = /^\[(?:([a-z-]+):)?(.+)\]$/i,
        ...
        Wr = /\d+(%|px|r?em|[sdl]?v([hwib]|min|max)|pt|pc|in|cm|mm|cap|ch|ex|r?lh|cq(w|h|i|b|min|max))|\b(calc|min|max|clamp)\(.+\)|^0$/,
        jr = /^-?((\d+)?\.?(\d+)[a-z]+|0)_-?((\d+)?\.?(\d+)[a-z]+|0)/;

    function h(r) {
        return M(r) || Er.has(r) || Nr.test(r) || L(r)
    }

    function L(r) {
        return P(r, "length", Or)
    }
    ...
    function T() {
        var r = d("colors"),
            ...
            x = d("gradientColorStopPositions"),
            m = d("inset"),
            w = d("margin"),
            k = d("opacity"),
            A = d("padding"),
        ...
        return {
            ...
            theme: {
                ...
                gradientColorStopPositions: [_, L],
                inset: J(),
                margin: J(),
                opacity: N(),
                padding: p(),
    ...
    function O(r, e) {
        for (var t in e) Mr(r, t, e[t]);
        return r
    }
    var Fr = Object.prototype.hasOwnProperty,
        qr = new Set(["string", "number", "boolean"]);

    function Mr(r, e, t) {
        if (!Fr.call(r, e) || qr.has(typeof t) || t === null) {
            r[e] = t;
            return
        }
        ...
        if (typeof t == "object" && typeof r[e] == "object") {
            if (r[e] === null) {
                r[e] = t;
                return
            }
            for (var o in t) Mr(r[e], o, t[o])
        }
    }

    function kr(r) {
        for (var e = arguments.length, t = new Array(e > 1 ? e - 1 : 0), o = 1; o < e; o++) t[o - 1] = arguments[o];
        return typeof r == "function" ? S.apply(void 0, [T, r].concat(t)) : S.apply(void 0, [function() {
            return O(T(), r)
        }].concat(t))
    }
    var Sr = S(T);
    ...
    document.querySelectorAll("[data-tw-merge]").forEach(r => {
        r.setAttribute("class", Zr(r.getAttribute("class"))), r.removeAttribute("data-tw-merge")
    });
    window.twMerge = $;
})();